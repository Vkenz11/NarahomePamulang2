...
export const PROPERTY_CONFIG = {
  ...
  units: [
    ...
    { id: "unit-C-02", number: "C-02", status: "Booked", isReady: true, price: "Rp800an Juta*", specs: { land: 60, building: 74 }, image: "/assets/images/1 PDF 3D DENAH - PROJECT CLUSTER - PAMULANG, TANGERANG SELATAN - BAPAK RAMLI_page-0005.webp", imageLantai2: "/assets/images/1 PDF 3D DENAH - PROJECT CLUSTER - PAMULANG, TANGERANG SELATAN - BAPAK RAMLI_page-0006.webp" },
